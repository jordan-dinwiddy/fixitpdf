...
- [X] If user doesn't have sufficient credits they'll be prompted to purchase more.
- [X] Clicking 'sign-in' will display modal asking user to choose identity provider. 
- [X] Dragging/dropping file when not logged in will prompt user to choose identity provider.
- [X] New users get 5 credits. 
- [X] Users can purchase credits
- [X] Emails
